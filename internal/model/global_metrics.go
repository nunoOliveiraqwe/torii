...
type GlobalProxyMetricsDal interface {
	GetGlobalProxyMetrics(ctx context.Context) (*GlobalProxyMetrics, error)
	UpdateGlobalProxyMetrics(ctx context.Context, metrics *GlobalProxyMetrics) error
}
