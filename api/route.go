...
var routes = []ApplicationRoute{
	...
	},
	{
		...
		Description:        "Returns available network interfaces with their IPv4/IPv6 addresses",
		Method:             "GET",
	...
	},
	{
		...
		Description:        "Creates a new HTTP from a full configuration payload",
		Method:             "POST",
		Pattern:            "/proxy/routes/http",
		IsAllowedBeforeFts: false,
		IsAllowedAfterFts:  true,
		IsSecure:           true,
		HandlerFunc:        handleCreateHttpProxyServer,
	},
	{
		Name:               "Middleware Schemas",
		Description:        "Returns the schema for all available middlewares (field types, defaults, help text)",
		Method:             "GET",
		Pattern:            "/proxy/middlewares/schema",
		IsAllowedBeforeFts: false,
		IsAllowedAfterFts:  true,
		IsSecure:           true,
		HandlerFunc:        handleGetMiddlewareSchemas,
	},
	{
	...
	{
		Name:               "Delete a proxy",
		Description:        "Deletes a proxy and all its configuration",
		Method:             "DELETE",
		Pattern:            "/proxy/routes/{serverId}",
		IsAllowedBeforeFts: false,
		IsAllowedAfterFts:  true,
		IsSecure:           true,
		HandlerFunc:        handleDeleteProxy,
	},
	{
		Name:               "Get Proxy Config",
		Description:        "Returns the original creation config for a proxy by port",
		Method:             "GET",
		Pattern:            "/proxy/routes/{serverId}/config",
		IsAllowedBeforeFts: false,
		IsAllowedAfterFts:  true,
		IsSecure:           true,
		HandlerFunc:        handleGetProxyConfig,
	},
	{
		Name:               "Edit Proxy",
		Description:        "Edits an existing proxy by hot-swapping its handler",
		Method:             "PUT",
		Pattern:            "/proxy/routes/{serverId}",
		IsAllowedBeforeFts: false,
		IsAllowedAfterFts:  true,
		IsSecure:           true,
		HandlerFunc:        handleEditProxy,
	},
	{
	...
	{
		Name:               "Toggle ACME Enabled",
		Description:        "Enables or disables ACME without changing the configuration",
		Method:             "PATCH",
		Pattern:            "/acme/config",
		IsAllowedBeforeFts: false,
		IsAllowedAfterFts:  true,
